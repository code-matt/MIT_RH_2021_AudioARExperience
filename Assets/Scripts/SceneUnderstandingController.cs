...
namespace ASV
{
    public class SceneUnderstandingController : MonoBehaviour, IMixedRealitySpatialAwarenessObservationHandler<SpatialAwarenessSceneObject>
    {
        ...
        [SerializeField]
        private string SavedSceneNamePrefix = "SavedSceneUnderstandingScene";
        [SerializeField]
